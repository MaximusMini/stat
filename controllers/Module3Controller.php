...
class Module3Controller extends Controller
{
    ...
    // формирование и вывод постера с результатами матча дня
     public function actionPosterFinalScore()
    {
         // получаем массив с данными из вида main.php
         $data_poster = Yii::$app->request->get();
         return $this->render('poster_final_score',['data_poster'=>$data_poster]);
    }
